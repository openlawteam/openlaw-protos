...
final case class ExecuteResponse(
    ...
    status: integration.framework.openlaw.ExternalService.ExecuteResponse.Status = integration.framework.openlaw.ExternalService.ExecuteResponse.Status.FAILURE,
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      {
        val __value = status
        if (__value != integration.framework.openlaw.ExternalService.ExecuteResponse.Status.FAILURE) {
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = status
        if (__v != integration.framework.openlaw.ExternalService.ExecuteResponse.Status.FAILURE) {
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): integration.framework.openlaw.ExternalService.ExecuteResponse = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 48 =>
            __status = integration.framework.openlaw.ExternalService.ExecuteResponse.Status.fromValue(_input__.readEnum())
          case 58 =>
    ...
    def withStatus(__v: integration.framework.openlaw.ExternalService.ExecuteResponse.Status): ExecuteResponse = copy(status = __v)
    ...
    def companion = integration.framework.openlaw.ExternalService.ExecuteResponse
}

object ExecuteResponse extends scalapb.GeneratedMessageCompanion[integration.framework.openlaw.ExternalService.ExecuteResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[integration.framework.openlaw.ExternalService.ExecuteResponse] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): integration.framework.openlaw.ExternalService.ExecuteResponse = {
    ...
    integration.framework.openlaw.ExternalService.ExecuteResponse(
      ...
      integration.framework.openlaw.ExternalService.ExecuteResponse.Status.fromValue(__fieldsMap.getOrElse(__fields.get(5), integration.framework.openlaw.ExternalService.ExecuteResponse.Status.FAILURE.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber),
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[integration.framework.openlaw.ExternalService.ExecuteResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      integration.framework.openlaw.ExternalService.ExecuteResponse(
        ...
        integration.framework.openlaw.ExternalService.ExecuteResponse.Status.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(integration.framework.openlaw.ExternalService.ExecuteResponse.Status.FAILURE.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 6 => integration.framework.openlaw.ExternalService.ExecuteResponse.Status
    }
  }
  lazy val defaultInstance = integration.framework.openlaw.ExternalService.ExecuteResponse(
  )
  ...
  sealed trait Status extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Status] = integration.framework.openlaw.ExternalService.ExecuteResponse.Status
  }
  ...
  object Status extends _root_.scalapb.GeneratedEnumCompanion[Status] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = integration.framework.openlaw.ExternalService.ExecuteResponse.javaDescriptor.getEnumTypes.get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = integration.framework.openlaw.ExternalService.ExecuteResponse.scalaDescriptor.enums(0)
  }
  implicit class ExecuteResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, integration.framework.openlaw.ExternalService.ExecuteResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, integration.framework.openlaw.ExternalService.ExecuteResponse](_l) {
    ...
    def status: _root_.scalapb.lenses.Lens[UpperPB, integration.framework.openlaw.ExternalService.ExecuteResponse.Status] = field(_.status)((c_, f_) => c_.copy(status = f_))
  ...
  def of(
    ...
    outputJson: _root_.scala.Predef.String,
    outputSignature: _root_.scala.Predef.String,
    status: integration.framework.openlaw.ExternalService.ExecuteResponse.Status,
    message: _root_.scala.Predef.String,
    servicePublicAddress: _root_.scala.Predef.String
  ): _root_.integration.framework.openlaw.ExternalService.ExecuteResponse = _root_.integration.framework.openlaw.ExternalService.ExecuteResponse(
    callerId,
    actionId,
    requestId,
    outputJson,
