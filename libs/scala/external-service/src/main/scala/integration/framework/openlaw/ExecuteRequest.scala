...
final case class ExecuteRequest(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): integration.framework.openlaw.ExecuteRequest = {
    ...
    def companion = integration.framework.openlaw.ExecuteRequest
}

object ExecuteRequest extends scalapb.GeneratedMessageCompanion[integration.framework.openlaw.ExecuteRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[integration.framework.openlaw.ExecuteRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): integration.framework.openlaw.ExecuteRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[integration.framework.openlaw.ExecuteRequest] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = integration.framework.openlaw.ExecuteRequest(
    callerId = "",
    actionId = "",
    requestId = "",
    inputJson = "",
  ...
  implicit class ExecuteRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, integration.framework.openlaw.ExecuteRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, integration.framework.openlaw.ExecuteRequest](_l) {
  ...
  def of(
    ...
    inputJson: _root_.scala.Predef.String,
    servicePublicAddress: _root_.scala.Predef.String
  ): _root_.integration.framework.openlaw.ExecuteRequest = _root_.integration.framework.openlaw.ExecuteRequest(
    callerId,
    actionId,
    requestId,
    inputJson,
